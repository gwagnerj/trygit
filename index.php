...
echo('<table border="1">'."\n");
	...
	echo("</td></tr>\n");
$qstmnt="SELECT problem.problem_id AS problem_id,problem.name AS name,problem.email as email,problem.title as title,problem.docxfilenm as docxfilenm,problem.infilenm as infilenm,School.s_name as s_name
...
<p></p>
<a href="requestPblmNum.php">Request New Problem Number</a>
</body>
</html>